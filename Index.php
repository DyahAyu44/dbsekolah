...
<html lang="en">
  ...
  if (isset($_POST['login'])){
    $user = $_POST['user'];
    $pass = $_POST['pass'];
    $data_user = mysqli_query($conn, "SELECT * FROM tb_user WHERE username = '$user' AND password = '$pass'");
          ...
          <div class = "col-md-6">
              ...
              <form action = "" method = "post">
                  ...
                  <div class = "form-group form-cheeck">
                      <input type ="checkbox" name = "checkbox" class = "form-cehck-input" id="checkbox">
